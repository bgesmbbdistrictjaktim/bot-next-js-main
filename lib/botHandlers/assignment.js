...
const { getStatusEmoji, getProgressStatusEmoji, getStageEmoji, getStageStatusEmoji, nowJakartaWithOffset, formatOrderCard, formatAssignmentSimple, formatIndonesianDateTime, sortOrdersNewestFirst } = require('../botUtils');
...
async function showOrderSelectionForStageAssignment(client, chatId, telegramId) {
  try {
    ...
    // Tambahkan tombol Batalkan di akhir daftar
